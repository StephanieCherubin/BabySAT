...
Create a new **index.js** file and add the following code to try out some basic CRUD
...
Add to **index.js** the following function which uses the **insertMany**
